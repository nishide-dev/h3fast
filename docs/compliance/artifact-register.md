...
| Private human-pairwise ballot / assignment / seed | H3Fast独自のlocal review artifact | formal case ID、blind A/B判断、hidden assignment、salt、seedを含む。prompt/media/pathは含めない | Apache-2.0候補 | repository外・access制御 | schema、prepare/check CLI、commitment検証とaggregate scorerを実装。offline presentation runner、pilot、formal reviewは未完了。Git/CI artifact化禁止 |
