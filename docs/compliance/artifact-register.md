...
| SGLang adapter metadata | 独自実装 | SGLang commit `6eb941a34cb100b708a42ed1d26d2bdefafbd01e`との互換候補を記録。コードcopyなし | Apache-2.0 | Public候補 | H3 E2E未検証 |
...
| Benchmark outputs | 未作成 | H3 Outputを含み得る | H3 license・AUP review必須 | 非公開 | 2×RTX 6000 AdaでのH3 E2E・license review待ち |
